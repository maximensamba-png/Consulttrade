        ...
        <div className="grid gap-10 border-b border-white/10 pb-10 md:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
          <div>
            ...
            <p className="max-w-md text-sm leading-7 text-slate-300">
                  Entreprise multisectorielle spécialisée dans le BTP, le négoce,
              la représentation, la distribution de dispositifs médicaux,
              l’ingénierie, l’exploitation fluviale, les nouvelles technologies,
              la digitalisation, l’intelligence artificielle et la cybersécurité.
            </p>
          </div>
          <div>
